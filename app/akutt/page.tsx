    ...
    <>
      ...
      >
        <div className="container-xl text-center">
          ...
          <a
            href={`tel:${company.phone}`}
            className="inline-flex items-center gap-2.5 rounded-full bg-emergency-600 px-10 py-4 text-lg font-bold text-white hover:bg-emergency-700 transition-colors pulse-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
          >
