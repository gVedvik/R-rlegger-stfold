...
export const metadata: Metadata = buildMetadata({
  title: "Personvernerklæring – Østfold Rørleggerbedrift AS",
  description:
    "Les personvernerklæringen til Østfold Rørleggerbedrift AS. Vi behandler dine personopplysninger i samsvar med GDPR og norsk personvernlovgivning.",
  path: "/personvern",
  noIndex: true,
});
